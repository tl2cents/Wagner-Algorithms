...
// g++ -I./include -I./third_party/kxsort -I./third_party/blake2-avx2 src/benchmarks/inplace_merge_benchmark.cpp third_party/blake2-avx2/blake2bip.c third_party/blake/blake2b.cpp -o benchmark_merge -std=c++17 -O3 -march=native -mavx2 -funroll-loops -Wall -Wextra -Wno-unused-variable